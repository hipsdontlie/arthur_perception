...
class Registration():
    ...
    def manual_registration(self, target=None):
        ...
        np.save('registration_transform.npy', reg_p2p.transformation)
        ...
        evaluation = o3d.pipelines.registration.evaluate_registration(source, target_s, threshold, reg_p2p.transformation)
...
rospy.init_node('registration_node_v4', anonymous=True)
